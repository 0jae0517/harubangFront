            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-xl shadow-md flex items-center gap-4 transition-transform hover:scale-105">
                    ...
                    <div>
                        ...
                        <p className="text-2xl font-bold text-harubang-ink">{totalUsers}명</p>
                    </div>
                </div>
                {/* 총 신청서 수 */}
                <div className="bg-white p-6 rounded-xl shadow-md flex items-center gap-4 transition-transform hover:scale-105">
                    ...
                    <div>
                        ...
                        <p className="text-2xl font-bold text-harubang-ink">{totalRequests}건</p>
                    </div>
                </div>
                {/* 총 매물 수 */}
                <div className="bg-white p-6 rounded-xl shadow-md flex items-center gap-4 transition-transform hover:scale-105">
                    ...
                    <div>
                        ...
                        <p className="text-2xl font-bold text-harubang-ink">{totalProperties}건</p>
                    </div>
                </div>
            </div>

            <div className="mt-8 bg-white p-6 rounded-xl shadow-md">
                <h2 className="text-xl font-bold mb-4 text-harubang-ink">최근 활동 (구현 예정)</h2>
                <p className="text-gray-600">이곳에 최근 가입한 회원 목록이나, 새로 등록된 신청서 목록 등을 동적으로 표시할 수 있습니다.</p>
            </div>
        </div>
    );
};
