...
const ChatPage: React.FC = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "안녕하세요! 제안드린 강남구 역삼동 아파트 매물 관련해서 문의드립니다.",
      sender: "me",
    },
    {
      id: 2,
      text: "네, 고객님 안녕하세요! 어떤 점이 궁금하신가요?",
      sender: "other",
    },
  ]);
    ...
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <header className="bg-white border-b shadow-sm z-10">
        <div className="container mx-auto px-4 py-3 flex items-center">
          <Link
            to="/mypage"
            className="text-gray-500 hover:text-harubang-blue mr-4"
          >
            <ArrowLeft />
          </Link>
          <div>
      ...
      <footer className="bg-white border-t p-4">
        <form onSubmit={handleSendMessage} className="flex items-center gap-2">
          ...
          <button
            type="submit"
            className="bg-harubang-blue text-white p-3 rounded-full hover:bg-harubang-blue-dark transition-colors flex-shrink-0"
          >
            <Send />
          </button>
        </form>
