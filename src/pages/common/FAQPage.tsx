...
const faqData = [
  {
    ...
    answer:
      "'하루방'은 고객이 원하는 집의 조건을 신청서로 작성하면, 여러 공인중개사가 그에 맞는 최적의 매물 1건씩을 직접 제안하는 역제안 방식의 맞춤형 부동산 매칭 플랫폼입니다. 불필요한 발품과 허위 매물 걱정을 덜어드리는 것을 목표로 합니다.",
  },
  {
    question: "기존 부동산 플랫폼과는 무엇이 다른가요?",
    answer:
      "기존 앱이 수많은 매물을 나열하고 사용자가 직접 필터링하며 찾아야 하는 방식이라면, '하루방'은 정반대입니다. 고객님의 신청서를 보고 전문가인 중개사가 직접 조건에 맞는 매물을 선별하여 제안하기 때문에, 정보 과잉으로 인한 피로 없이 양질의 매물만 확인할 수 있습니다.",
  },
  {
    question: "신청서는 어떻게 작성해야 하나요?",
    answer:
      "원하는 지역, 예산, 집 종류 등 기본적인 정보와 함께, '반려동물을 키워요', '남향집이었으면 좋겠어요', '조용한 동네를 원해요' 등 자유로운 형식으로 희망사항을 자세하게 적어주실수록 좋습니다. 자세할수록 중개사님이 더 꼭 맞는 집을 찾아드릴 확률이 높아집니다.",
  },
  {
    question: "중개 수수료 외에 추가 비용이 있나요?",
    answer:
      "아니요. 고객님이 '하루방' 서비스를 이용하는 데에는 어떠한 추가 비용도 발생하지 않습니다. 부동산 계약 시 발생하는 법정 중개보수 외에는 무료로 이용하실 수 있습니다.",
  },
  {
    question: "허위 매물은 없나요?",
    answer:
      "'하루방'은 중개사님이 직접 실수요 고객에게 매물을 제안하는 구조이므로, 허위·미끼 매물을 올릴 이유가 없습니다. 또한, 중개사 인증 및 사용자 피드백 시스템을 통해 신뢰할 수 있는 매물만 추천되도록 관리하고 있습니다.",
  },
];
...
const FAQItem: React.FC<FAQItemProps> = ({ question, answer }) => {
  ...
  return (
    <div className="border-b">
      ...
      >
        <span className="text-lg font-semibold text-harubang-ink">
          {question}
        </span>
        <motion.div
    ...
    <div className="bg-white">
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="mt-20 text-center bg-harubang-sky p-10 rounded-xl">
          <h2 className="text-2xl font-bold text-harubang-ink mb-3">
            찾으시는 답변이 없나요?
          </h2>
          <p className="text-harubang-ink-light mb-6">
            추가적인 문의나 궁금한 점이 있다면 언제든지 편하게 연락주세요.
          </p>
