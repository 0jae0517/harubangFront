    ...
    <header className="bg-white/80 backdrop-blur-sm sticky top-0 z-40 border-b border-gray-200">
      <nav className="container mx-auto px-6 h-20 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-28 font-semibold">
          ...
          <NavLink to="/apply" className={getNavStyle}>
            신청서 작성
          </NavLink>
          <NavLink to="/faq" className={getNavStyle}>
            FAQ
          </NavLink>
        </div>
          ...
          {isLoggedIn ? (
            <div className="flex items-center gap-4">
              {userRole === "customer" && (
                <Link
                  to="/mypage"
                  className="font-semibold text-gray-700 hover:text-harubang-blue flex items-center gap-2"
                >
                  <User size={18} /> 내 정보
                </Link>
              )}
              ...
              <button
                ...
                className="text-gray-500 hover:text-harubang-blue flex items-center gap-2"
              >
                <LogOut size={18} /> 로그아웃
              </button>
            </div>
