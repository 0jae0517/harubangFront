    ...
    <div className="container mx-auto px-6 py-16">
      <div className="grid md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-5 grid grid-cols-2 gap-8">
          <div>
            <h4 className="font-bold text-harubang-ink mb-4 tracking-wider">
              서비스
            </h4>
            <ul className="space-y-3 text-sm text-harubang-ink-light">
              <li>
                <Link
                  to="/about"
                  className="hover:text-harubang-blue transition-colors"
                >
                  서비스 소개
                </Link>
              </li>
        ...
        <div className="md:col-span-3">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://www.instagram.com/harubang_official?igsh=MWg5Nm1uN2lrcjltZQ=="
              target="_blank"
              rel="noopener noreferrer"
              className="text-harubang-ink-light hover:text-black transition-colors"
              aria-label="Instagram"
            >
              <Instagram size={24} />
            </a>
            <a
              href="http://pf.kakao.com/_xhvRUn"
              target="_blank"
              rel="noopener noreferrer"
              className="text-harubang-ink-light hover:text-black transition-colors"
      ...
      <div className="mt-16 pt-8 border-t border-gray-100 text-sm text-gray-400">
        ...
        <p>
          &copy; {new Date().getFullYear()} Harubang Inc. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
